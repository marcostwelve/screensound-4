...
public static class ArtistasExtensions
{
    public static void AddEndPointsArtistas(this WebApplication app)
    {
            ...
            ) =>
        {
            ...
            var email = context.User.Claims.FirstOrDefault(c => c.Type.Equals(ClaimTypes.Email))?.Value ?? throw new InvalidOperationException("Não foi encontrada pessoa logada");

            var pessoa = dalPessoa.RecuperarPor(p => p.Email!.Equals(email)) ?? throw new InvalidOperationException("Não foi possível encontrar a pessoa logada");
